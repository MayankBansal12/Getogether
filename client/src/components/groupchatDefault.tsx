// This is the Home component for host/vendor/guests
const Groups = () => {
  return (
    <div className="flex flex-col justify-center items-center py-4 w-full h-[60vh] font-josefin">
      ...
      <p className="font-bold text-3xl">
        Share new announcements with your people
      </p>
      <p className="py-4 font-medium text-center text-dull text-lg underline">
        This is the Group Chat section for your event.
      </p>
      <p className="font-medium text-dull text-xl">
        Open the chats to view and send messages, updates and details.
      </p>
    </div>
  )
}
